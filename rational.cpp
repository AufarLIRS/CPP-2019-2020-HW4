...
Rational::Rational() : numerator_(0), denumerator_(1), db_(0.0)
{
}
...
Rational::Rational(int num, int den)
{
  ...
  db_ = static_cast<double>(num) / static_cast<double>(den);
}
...
{
  double tmp;
  tmp = db + static_cast<double>(rat.get_n()) / static_cast<double>(rat.get_d());
  return tmp;
}
...
{
  double tmp;
  tmp = static_cast<double>(rat.get_n()) / static_cast<double>(rat.get_d()) + db;
  return tmp;
}
...
{
  double tmp;
  tmp = static_cast<double>(rat1.get_n()) / static_cast<double>(rat1.get_d()) * static_cast<double>(rat2.get_n()) /
        static_cast<double>(rat2.get_d());
  return tmp;
}
